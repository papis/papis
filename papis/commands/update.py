...
import papis.utils
from papis.strings import AnyString, FormattedString, process_formatted_string_pair
...
def cli(
    ...
    sort_reverse: bool,
    to_set: List[Tuple[str, FormattedString]],
    to_drop: List[str],
    to_append: List[Tuple[str, FormattedString]],
    to_remove: List[Tuple[str, FormattedString]],
    to_rename: List[Tuple[str, FormattedString, FormattedString]],
) -> None:
